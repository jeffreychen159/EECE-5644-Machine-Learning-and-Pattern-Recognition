...
training_500 = np.genfromtxt('./data/training_500.csv', delimiter=',')
testing_100000 = np.genfromtxt('./data/test_100000.csv', delimiter=',')

training_500_x = training_500[:, :3]
training_500_y = training_500[:, 3:].astype('int')
testing_100000_x = testing_100000[:, :3]
testing_100000_y = testing_100000[:, 3:].astype('int')

# One-hot encode the targets
training_500_y = to_categorical(training_500_y, num_classes=4)
testing_100000_y = to_categorical(testing_100000_y, num_classes=4)

inputs = training_500_x.astype('float32')
targets = training_500_y.astype('int')
...
np.savetxt('./predictions/predictions_500.csv', final_predictions, delimiter=',')
