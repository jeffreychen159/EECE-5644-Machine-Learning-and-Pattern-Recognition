...
training_100 = np.genfromtxt('./data/training_100.csv', delimiter=',')
testing_100000 = np.genfromtxt('./data/test_100000.csv', delimiter=',')

training_100_x = training_100[:, :3]
training_100_y = training_100[:, 3:].astype('int')
testing_100000_x = testing_100000[:, :3]
testing_100000_y = testing_100000[:, 3:].astype('int')

# One-hot encode the targets
training_100_y = to_categorical(training_100_y, num_classes=4)
testing_100000_y = to_categorical(testing_100000_y, num_classes=4)

inputs = training_100_x.astype('float32')
targets = training_100_y.astype('int')
...
np.savetxt('./predictions/predictions_100.csv', final_predictions, delimiter=',')
