...
training_1000 = np.genfromtxt('./data/training_1000.csv', delimiter=',')
testing_100000 = np.genfromtxt('./data/test_100000.csv', delimiter=',')

training_1000_x = training_1000[:, :3]
training_1000_y = training_1000[:, 3:].astype('int')
testing_100000_x = testing_100000[:, :3]
testing_100000_y = testing_100000[:, 3:].astype('int')

# One-hot encode the targets
training_1000_y = to_categorical(training_1000_y, num_classes=4)
testing_100000_y = to_categorical(testing_100000_y, num_classes=4)

inputs = training_1000_x.astype('float32')
targets = training_1000_y.astype('int')
...
np.savetxt('./predictions/predictions_1000.csv', final_predictions, delimiter=',')
