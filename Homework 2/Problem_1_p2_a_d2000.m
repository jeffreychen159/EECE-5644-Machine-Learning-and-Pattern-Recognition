...
T_train_2000 = table2array(readtable('d2000_train.csv'))';
...
writematrix(H, 'actual_t2000_log.csv');
writematrix(rounded, 'rounded_t2000_log.csv');
...
error_d2000 = 1 - accuracy_rate_rounded;
error_d2000, 
