...
def main(): 
    ...
    d20_train_x, d20_train_labels, gmmParameters_20 = generateData(20)
    d20_train = np.vstack((d20_train_x, d20_train_labels)).T
    np.savetxt('d20_train.csv', d20_train, delimiter=',')

    d200_train_x, d200_train_labels, gmmParameters_200 = generateData(200)
    d200_train = np.vstack((d200_train_x, d200_train_labels)).T
    np.savetxt('d200_train.csv', d200_train, delimiter=',')

    d2000_train_x, d2000_train_labels, gmmParameters_2000 = generateData(2000)
    d2000_train = np.vstack((d2000_train_x, d2000_train_labels)).T
