...
T_train_200 = table2array(readtable('d200_train.csv'))';
...
% Optimize model
options = optimset('MaxFunEvals',1e10*length(vecParamsInit)); % Matlab default is 200*length(vecParamsInit)
...
writematrix(H, 'actual_t200_log.csv');
writematrix(rounded, 'rounded_t200_log.csv');
...
error_d200 = 1 - accuracy_rate_rounded;
error_d200, 
